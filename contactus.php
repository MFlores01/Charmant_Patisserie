...
<html>
  ...
  <head>
    <title> Contact | Charmant Pâtisserie' </title>
  </head>
...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> Charmant Pâtisserie' </span>?</strong>
     <br>
    <p class="sub">Here are a few ways to get in touch with us.</p>
    </div>
    <div class="container" >
