...
$gtotal = 0;
  foreach($_SESSION["cart"] as $keys => $values)
  {
    ...
    $F_ID = $values["pâtisserie_id"];
    $pâtisseriename = $values["pâtisserie_name"];
    $quantity = $values["pâtisserie_quantity"];
    $price =  $values["pâtisserie_price"];
    $total = ($values["pâtisserie_quantity"] * $values["pâtisserie_price"]);
    $R_ID = $values["R_ID"];
    ...
    $gtotal = $gtotal + $total;
     ...
     $query = "INSERT INTO ORDERS (F_ID, pâtisseriename, price,  quantity, order_date, username, R_ID) 
              VALUES ('" . $F_ID . "','" . $pâtisseriename . "','" . $price . "','" . $quantity . "','" . $order_date . "','" . $username . "','" . $R_ID . "')";
