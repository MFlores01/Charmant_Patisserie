...
<html>
  ...
  <link rel="stylesheet" type = "text/css" href ="css/view_pâtisserie_items.css">
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="view_pâtisserie_items.php" class="list-group-item active">View Pâtisserie Items</a>
...
$sql = "SELECT * FROM pâtisserie f WHERE f.R_ID IN (SELECT r.R_ID FROM BAKERY r WHERE r.M_ID='$user_check') ORDER BY F_ID";
