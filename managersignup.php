<html>
  ...
  <head>
    <title> Manager Signup | Charmant Pâtisserie' </title>
  </head>
  ...
  <body>
    ...
    <div class="heading">
     <h1 class="welcome"> Welcome to <span class="edit"> Charmant Pâtisserie' </span></h1>
   <p class="sub">Get started by creating your account</p>
    </div>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        <div class="panel-heading"> Create Account (Manager) </div>
  ...
  <br>
  <p> Charmant Pâtisserie' | &copy All Rights Reserved </p>
  <br>
  </footer>
</html>